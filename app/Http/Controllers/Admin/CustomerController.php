...
class CustomerController extends Controller
{
    ...
    public function index(Request $request){
        $data = ['tbl' => $this->tbl, 'control' => 'Customers'];
        return view('admin.sales.customer.list')->with($data);
    }

    public function getedit(Request $request){
        $response = Customer::where('id', $request->id)->first();
    ...
    public function CustomerInDropDown(Request $request){
        try {
            $searchTerm = '';
            ...
            $response = Customer::where('is_active', constants('is_active_yes'))
    ...
    public function change_customer_deleted(Request $request) {
        $request->validate([
         ...
         try {
            ...
            $count1 = Invoice::where('customer_id', $request->id)->count();
            $count2 = 0;

            if(($count2+$count1)<1){
                $Customer = Customer::where('id', $request->id)->first();
                CreateLogsDeletedData($Customer);
