...
<!-- Favicon -->
<link rel="shortcut icon" href='{{ sendPath(constants("company_files")).getCompanyConfiguration()->invoice_logo}}'>
<!-- Bootstrap CSS -->
...
<link href="{{ asset('admin_assets/assets/plugins/sweetalerts/sweetalert2.min.css')}}" rel="stylesheet" type="text/css" />
<link href="{{ asset('admin_assets/assets/plugins/sweetalerts/sweetalert.css')}}" rel="stylesheet" type="text/css" />
<link href="{{ asset('admin_assets/assets/plugins/sweetalerts/custom-sweetalert.css')}}" rel="stylesheet" type="text/css" />
<link rel="stylesheet" href="{{ asset('admin_assets/assets/css/select2.min.css') }}"  />
